class Weapon_scythe extends Weapon {
    constructor(game) {
        ...
        let upgrades = [
            ...
            new Upgrade("Blood Scythe", "(Unique) Heal 1.5% HP per attack.", true, "./sprites/upgrade_blood_scythe.png", 300, 0.25),
            new Upgrade("Dual Blade", "(Unique) Adds primary back attack.", true, "./sprites/upgrade_dual_blade.png", 300, 0.15),
            new Upgrade("Echo Slash", "(Unique) Adds attack echoes.", true, "./sprites/upgrade_echo_slash.png", 250, 0.15),
            new Upgrade("Crippling Chill", "(Unique) Cripple effect on attacks.", true, "./sprites/upgrade_crippling_chill.png", 225, 0.3),
            new Upgrade("Bleeding Edge", "(Unique) +50% dmg. Dmg is now over-time.", true, "./sprites/upgrade_bleeding_edge.png", 300, 0.15)
        ];
        ...
        this.debugName = "Scythe"; // For debug logging
